...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/seeker/profile" method="post">
        <div class="row">
            <div class="form-group">
                <label>Name</label>
                <input type="text" name="name" value="${seeker.name}" required />
            </div>
            <div class="form-group">
                <label>Email</label>
                <input type="email" name="email" value="${seeker.email}" required />
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group">
                <label>Phone</label>
                <input type="text" name="phone" value="${seeker.phone}" />
            </div>
            <div class="form-group">
                <label>Experience (Years)</label>
                <input type="number" name="experience" min="0" value="${seeker.experience}" />
            </div>
        </div>

        <div class="form-group">
            <label>Skills</label>
            <textarea name="skills">${seeker.skills}</textarea>
        </div>
    ...
    <p style="margin-top:15px;">
        <a href="${pageContext.request.contextPath}/seeker/dashboard">Back to Dashboard</a>
    </p>
</div>
</body>
</html>